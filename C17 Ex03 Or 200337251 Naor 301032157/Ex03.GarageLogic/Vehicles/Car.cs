   ...
   internal abstract class Car : Vehicle
    {
        ...
        public Car(string i_ModelName, string i_LicenceNumber) :base(i_ModelName, i_LicenceNumber, k_numOfWheels)
        {
        ...
        internal override void SetWheels(string i_ProducerName)
        {
            ...
            {
                Wheels.Add(new Wheel(i_ProducerName, 0, k_maximalAirPressure));
            }
        }
    }
}
